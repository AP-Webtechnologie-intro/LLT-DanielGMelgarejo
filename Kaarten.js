...
let VeemarktMap = L.map('Veemarkt').setView([51.23009, 4.41616], 17);
...
L.rectangle(bounds, {color: "#e60005", weight: 1}).addTo(VeemarktMap);

// plaats een marker met als tekst "AP-Hogeschool" en eronder "Ellermanstraat 33"
let apMarker = L.marker([51.23009, 4.41616]).addTo(VeemarktMap);
